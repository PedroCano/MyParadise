	...
	<template v-else>
		...
		<div class="diseño">
			...
			<div class="contenido">
				...
				<p> 
					Molino inspirado en los relatos de Don Quijote ahora más en la realidad que nunca. También preparado para en la época de la aceituna poder moler esta y dar a sus 
					agricultores un aceite de la mayor calidad posible.
					<br><br>
