	...
	<template v-else>
		...
		<div class="diseño">
			...
			<div class="contenido">
				...
				<p> 
					Chalet veraniego con materiales de alta calidad. Un lugar en el que poder disfrutar de un retiro espiritual, de unas vacaciones con amigos y/o familia o simplemente una 
					escapada de fin de semana. Listo para cualquier época del año.
					<br><br>
