<template>
	...
	<template v-else>
		...
		<div class="diseño">
			...
			<div class="contenido">
				<h1>IGLESIA FUENTE DIVINA</h1>
				<img src="../../assets/plans.jpg">
				<p> 
					Iglesia románica inspirada en el diseño de la parroquia de Santa María en el Vaticano. Hecha con los mejores materiales para que pueda durar por infinidad de años por el bien de sus feligreses.
					<br><br>
